...
final public class RoundedShadowComponent extends JComponent
{
   ...
   {
      this(component, shadowLength, maximumShadowTransparency, null);
   }


   public RoundedShadowComponent(final JComponent component, final int shadowLength, final int maximumShadowTransparency, final TransparencyController transparencyController)
   {
   ...
   public RoundedShadowComponent(final JFrame parent, final JComponent component, final int activeShadowLength, final int inactiveShadowLength, final int maximumShadowTransparency)
   {
      ...
      this.transparencyController = null;
